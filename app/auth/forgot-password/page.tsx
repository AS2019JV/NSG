                ...
                <div className="bg-white/80 backdrop-blur-xl border border-white/40 rounded-4xl shadow-xl shadow-slate-200/50 p-8 md:p-10">
                    ...
                    <div className="flex justify-center gap-2 mb-8">
                        {[1, 2, 3].map((s) => (
                            <div key={s} className={clsx(
                                ...
                                step === s ? "w-8 bg-blue-600" : "w-1.5 bg-slate-200"
                            )}></div>
                        ))}
                    </div>
                    ...
                    {step === 1 && (
                        <div className="animate-fade-in">
                            ...
                            <div className="space-y-6">
                                ...
                                >
                                    {isLoading ? "Validando sistema..." : (
                                        <>
                                            Enviar Código <Send className="w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                                        </>
                                    )}
                                </button>
                    ...
                    {step === 2 && (
                        <div className="animate-fade-in">
                            <div className="text-center mb-8">
                                ...
                                <h2 className="font-display font-bold text-2xl text-slate-900 mb-2">Protocolo de Verificación</h2>
                                <p className="text-slate-500 text-sm">Hemos enviado un código a tu Telegram vinculado.</p>
                            </div>
                    ...
                    {step === 3 && (
                        <div className="text-center animate-fade-in py-6">
                            ...
                            >
                                Ir al Inicio de Sesión <ChevronLeft className="w-4 h-4 rotate-180" />
                            </button>
                        </div>
                    )}
