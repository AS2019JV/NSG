...
import { ArrowRight, Activity, Users, DollarSign, TrendingUp, Briefcase, HeartPulse } from "lucide-react";
      ...
      <div className="p-6 lg:p-8 space-y-8 max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-bold text-navy-900">85/100</span>
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xl font-display font-bold text-navy-900">Tomorrow, 10 AM</span>
              </div>
              <div className="text-xs text-slate-500">
                Dr. Arriaga - General Checkup
              </div>
            </div>
          </DashboardCard>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-3xl font-display font-bold text-navy-900">3/5</span>
                <span className="text-xs font-bold text-purple-600 bg-purple-50 px-2 py-1 rounded-lg">
                  Goals Met
                </span>
              </div>
              <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                <div className="bg-purple-500 w-[60%] h-full rounded-full transition-all duration-1000"></div>
              </div>
            </div>
          </DashboardCard>
        </div>
