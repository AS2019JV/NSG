...
import { ArrowRight, Activity, Users, DollarSign, TrendingUp, Briefcase, Brain } from "lucide-react";
      ...
      <div className="p-6 lg:p-8 space-y-8 max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-bold text-navy-900">99.8%</span>
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-3xl font-display font-bold text-navy-900">45</span>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-3xl font-display font-bold text-navy-900">28</span>
                <span className="text-xs font-bold text-purple-600 bg-purple-50 px-2 py-1 rounded-lg">
                  Target: 30
                </span>
              </div>
              <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                <div className="bg-purple-500 w-[90%] h-full rounded-full transition-all duration-1000"></div>
              </div>
            </div>
          </DashboardCard>
        </div>
