    ...
    theme: {
        ...
        extend: {
            ...
            boxShadow: {
                ...
                sovereign:
                    "0 25px 50px -12px rgba(2, 6, 23, 0.12), 0 0 1px rgba(2, 6, 23, 0.1)",
                precision:
                    "0 0 0 1px rgba(15, 23, 42, 0.05), 0 10px 30px -5px rgba(0, 0, 0, 0.05)",
            ...
            animation: {
                ...
                "slide-up-toast":
                    "slideUpToast 0.5s cubic-bezier(0.16, 1, 0.3, 1) forwards",
                "slide-down":
            ...
            keyframes: {
                ...
                textGlow: {
                    "0%": {
                        opacity: "0.6",
                        textShadow: "0 0 5px rgba(59, 130, 246, 0)",
                    },
                    "100%": {
                        opacity: "1",
