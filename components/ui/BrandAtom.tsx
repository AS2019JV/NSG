                    ...
                    <defs>
                        {isValues.multicolor ? (
                            <linearGradient id={gradientId} x1="0%" y1="0%" x2="100%" y2="100%">
                                ...
                                <stop offset="50%" stopColor="#2563eb" /> {/* Professional Deep Blue */}
                                <stop offset="100%" stopColor="#60a5fa" /> {/* Light Blue for smooth loop */}
                            </linearGradient>
                        ) : isValues.colored ? (
                            <linearGradient id={gradientId} x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stopColor="#1d4ed8" /> {/* Enterprise Deep Blue */}
                                <stop offset="50%" stopColor="#3b82f6" /> {/* Enterprise Blue */}
