    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up pb-10">
      ...
      <div className="bg-white p-8 rounded-[2.5rem] shadow-card border border-slate-200">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            <h3 className="font-display font-bold text-2xl text-navy-900">Configuración del Sistema</h3>
            <p className="text-slate-500 text-sm mt-1">Administra tus preferencias y seguridad.</p>
          </div>
