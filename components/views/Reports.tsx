...
export default function Reports() {
  return (
    <div className="h-full animate-fade-in-up pb-10">
      <h3 className="font-display font-bold text-2xl text-navy-900 mb-6">Reportes & Data</h3>
      ...
      <h3 className="font-display font-bold text-2xl text-navy-900 mb-6 mt-12">Mis Entregables</h3>
