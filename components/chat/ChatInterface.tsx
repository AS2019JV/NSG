    ...
    const handleSubmit = async (e: React.SyntheticEvent) => {
        ...
        try {
            ...
            if (responseData.message === "Workflow was started") {
                assistantContent = "**Configuration Issue:** The N8N workflow started successfully, but returned the default message.";
            } else {
            ...
            if (error.response && error.response.status === 404) {
                errorMessage = "**Workflow Not Active:** The N8N test URL is not listening.";
